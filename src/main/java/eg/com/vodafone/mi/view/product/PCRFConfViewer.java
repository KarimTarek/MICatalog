...
public class PCRFConfViewer implements IBackendConfViewer
{
	...
	for (String key : step.getServices().keySet())
	{
	    ...
	    createLabelWithCaption(leftSide, rightSide, "Service:&nbsp;", service.get("SERVICE"));
	    createLabelWithCaption(leftSide, rightSide, "Service Package:&nbsp;", service.get("SERVICEPACKAGE"));
	    createLabelWithCaption(leftSide, rightSide, "Quota:&nbsp;", service.get("QUOTANAME"));
